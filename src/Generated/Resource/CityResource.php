...
/**
 * Generated from OpenAPI schema CityResource.
 *
 ...
 */
class CityResource extends ArrayBackedResource
{
    /* BEGIN AUTO FIELDS */
    public readonly int $id;
    public readonly string $name;
    public readonly string $code;
    public readonly int $isPopular;
    public readonly int $isActive;
    public readonly ?CountryResource $country;
    /* END AUTO FIELDS */
    ...
    public function __construct(array $attributes)
    {
        ...
        $this->isPopular = $this->int('is_popular');
        $this->isActive = $this->int('is_active');
        $this->country = is_array($this->get('country')) ? CountryResource::fromArray($this->get('country')) : null;
        /* END AUTO HYDRATION */
