...
/**
 * Generated from OpenAPI operation partnerCheckoutCheckPromotion (POST /bookings/check-promotion).
 *
 ...
 * fromArray() maps them.
 */
class PartnerCheckoutCheckPromotionRequest implements RequestPayload
{
    use BuildsPayload;
