...
/**
 * Generated from OpenAPI operation partnerAccountUpdateApplicant (POST /bookings/{code}/applicant/{id}).
 *
 ...
 * fromArray() maps them.
 */
class PartnerAccountUpdateApplicantRequest implements RequestPayload
{
    use BuildsPayload;
