...
/**
 * Generated from OpenAPI operation partnerToursGetReviewImages (GET /tours/{id}/get-all-image-reviews).
 *
 ...
 * fromArray() maps them.
 */
class PartnerToursGetReviewImagesRequest implements RequestPayload
{
    use BuildsPayload;
