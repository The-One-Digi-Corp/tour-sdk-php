...
class PartnerAccountListRefundsRequest implements RequestPayload
{
    ...
    public function __construct(
        public readonly array $tourBookingIds,
        /**
    ...
    public static function fromArray(array $payload): static
    {
        ...
        return new static(
            tourBookingIds: (isset($payload['tour_booking_ids']) && is_array($payload['tour_booking_ids']) ? $payload['tour_booking_ids'] : []),
    ...
    public function toArray(): array
    {
        return $this->withoutNulls([
            'tour_booking_ids' => $this->tourBookingIds,
        ]);
    }
